---
name: 'Flutter / Magic Framework'
description: 'Flutter and Magic framework conventions for all Dart files'
applyTo: 'lib/**/*.dart'
---
...
- All state classes: `extends ChangeNotifier with MagicStateMixin` — no Riverpod, no Bloc, no Provider
